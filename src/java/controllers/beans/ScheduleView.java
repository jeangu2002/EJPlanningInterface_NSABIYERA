...
public class ScheduleView implements Serializable {
    ...
    public void init() {
        ...
        try {
            competitions = new CompetitionRestClient().getAll(RestUrls.COMPETITION_URL);
            entrainements = new EntrainementRestClient().getAll(RestUrls.ENTRAINEMENT_URL);
            for(Competition c : competitions)
            {
                eventModel.addEvent(new DefaultScheduleEvent(c.getNom(), c.getDateCompetition(),c.getDateCompetition()));
            }
            for (Entrainement entrainement : entrainements) {
                eventModel.addEvent(new DefaultScheduleEvent("entrainement "+entrainement.getGroupe().getNom(), entrainement.getDateEntrainement(), entrainement.getDateEntrainement()));
            }
        } catch (Exception ex) {
